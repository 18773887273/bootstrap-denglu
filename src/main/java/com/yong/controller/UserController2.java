...
import com.yong.util.AuthService;
import com.yong.util.Base64Util;
import com.yong.util.HttpUtil;
...
public class UserController2 {
    ...
    public static boolean match(byte[] imgStr1, byte[] imgStr2) {
        ...
        try {
            ...
            String accessToken = AuthService.getAuth("GHxI31ixhq6bk65DVtkNHmZe",
                    "lZldSvW1Y012qoeccDRltZar5aiGebLj");
